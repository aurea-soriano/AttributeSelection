...
public class J48DecisionTreeClassifier implements Classifier {
    ...
    public String classify2(String dataPath, int numberThreads) {
        try {
            ...
            for (int i = 1; i <= numberThreads; i++) {
                ...
                listThreads.add(new J48DecisionTreeClassifierThread(beginPoint - 1, endPoint - 1, i));
            ...
            resultClassifier += "Accuracy of  J48 : " + String.format("%.2f%%", accuracy) + "\n";
            resultClassifier += "ROC of  J48 : " + String.format("%.2f%%", roc) + "\n";
            
            String[] classesNames = new String[data.numClasses()];
    ...
    class J48DecisionTreeClassifierThread extends Thread {

        Integer beginPoint;
        Integer endPoint;
        Integer numberThread;

        public J48DecisionTreeClassifierThread(Integer beginPoint, Integer endPoint, Integer numberThread) {
