...
public class SupportVectorMachineClassifier implements Classifier {
    ...
    public String classify2(String dataPath, int numberThreads) {
        try {
            String resultClassifier = "Support Vector Machine Classifier \n\n";
            ...
            for (int i = 1; i <= numberThreads; i++) {
                ...
                listThreads.add(new SuppportVectorMachineClassifierThread(beginPoint - 1, endPoint - 1, i));
            ...
            resultClassifier += "Accuracy of  SVM : " + String.format("%.2f%%", accuracy) + "\n";
            resultClassifier += "ROC of  SVM : " + String.format("%.2f%%", roc) + "\n";
    ...
    class SuppportVectorMachineClassifierThread extends Thread {

        Integer beginPoint;
        Integer endPoint;
        Integer numberThread;

        public SuppportVectorMachineClassifierThread(Integer beginPoint, Integer endPoint, Integer numberThread) {
