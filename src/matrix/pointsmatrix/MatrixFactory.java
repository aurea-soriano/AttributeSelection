...
public class MatrixFactory {
    ...
    /*public static AbstractMatrix getInstance(ProjectionView view, ProjectionData pdata) throws IOException {
    ...
    public static AbstractMatrix getTxtInstance(String filename) throws IOException {
        AbstractMatrix matrix = null;

        BufferedReader in = new BufferedReader(new java.io.FileReader(filename));

        matrix = new TxtMatrix();
        matrix.load(filename);

        return matrix;
    }

    public static AbstractMatrix getCsvInstance(String filename) throws IOException {
        AbstractMatrix matrix = null;

        BufferedReader in = new BufferedReader(new java.io.FileReader(filename));

        matrix = new CsvMatrix();
        matrix.load(filename);
